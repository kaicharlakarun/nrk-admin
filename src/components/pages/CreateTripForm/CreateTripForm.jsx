...
/>
          ...
          <NumberInput label="Driver Amount" name="driverBeta" value={formData.driverBeta} onChange={handleChange} />
        </div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  />
        ...
        <div className="flex justify-center">
          <button type="submit" disabled={loading} className="px-5 py-2 rounded border border-green-700 text-white bg-green-700 hover:bg-white hover:text-green-700 transition-colors duration-300">
