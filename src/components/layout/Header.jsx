      ...
      <header className="flex items-center justify-between p-4 border-b border-green-100 bg-white sticky top-0 z-10">
        ...
        <div className="flex items-center">
          <button
            ...
            className="px-4 py-2 rounded border border-green-700 text-green-700 bg-white hover:bg-green-700 hover:text-white transition-colors duration-300"
          >
            Sign Out
          </button>
        </div>
